...
def contour(image):
    ...
    triangle_cnt2 = np.array( [[0,0],[360,0],[0,360]] )
...
def estimateSpeed(carID,dis):
    ...
    speed = round(dis/timeDiff*3.6,2)
    return speed
...
def saveCar(speed,img):
    ...
    link = 'OUTPUT_DATA/Detail_info/'+nameCurTime+'.jpeg'
    link1 = 'OUTPUT_DATA/Number_plate/'+nameCurTime+'.jpeg'
